...
namespace TareaCamara.Services
{
    public class CameraService {
        ...
        public async Task<MediaFile> TakePhoto() {
            ...
            if (cameraOK == PermissionStatus.Granted && storageOK == PermissionStatus.Granted && CrossMedia.Current.IsCameraAvailable && CrossMedia.Current.IsTakePhotoSupported)
                {
